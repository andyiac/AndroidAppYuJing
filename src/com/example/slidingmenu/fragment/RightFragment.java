...
public class RightFragment extends Fragment implements
		ListView.OnScrollListener, AdapterView.OnItemClickListener,
	...
	private String[] telephone = { "15369317720", "15369317750", "15869331457",
			...
			"15869331457", "15230389135", "15369347750", "15369317720",
			"15369317750", "15869331457", "15230389135", "15369347750",
			"15369317720", "15369317750", "15869331457", "15230389135",
			"15369347750" };
		...
		try {
			...
			for (int i = 0; i < charArray.length; i++) {
				if (charArray[i] > 128) {
					...
					pinyinString += net.sourceforge.pinyin4j.PinyinHelper
							.toHanyuPinyinStringArray(charArray[i],
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		letterListView = (RightCharacterListView) view
				.findViewById(R.id.rightCharacterListView);
