...
import com.example.slidingmenu.fragment.pice.fragment.PersonCenterPiceFragment1;
...
public class PersonalCenterMainFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        PersonCenterPiceFragment1 page1 = new PersonCenterPiceFragment1();
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        showLeft.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ((PersonalCenterActivity) getActivity()).showLeft();
            }
        });
        ...
        showRight.setOnClickListener(new OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                ((PersonalCenterActivity) getActivity()).showRight();
            }
        });
    }
